//
//  ConvinceFirstAnimalViewController.m
//  Beestenbende
//
...
#import "ConvinceFirstAnimalViewController.h"

@interface ConvinceFirstAnimalViewController ()

@end

@implementation ConvinceFirstAnimalViewController
...
- (void)viewDidLoad
{
    ...
    [pageControl setCenter: CGPointMake(self.scrollView.center.x, self.scrollView.center.y + self.scrollView.bounds.size.height/2)] ;
